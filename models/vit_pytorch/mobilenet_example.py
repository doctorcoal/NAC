...
from Comp_Prototype import Comp_Base
...
class MobileViT(Comp_Base):
    ...
    def __init__(
        ...
        super().__init__(num_classes=num_classes, depth=1, w=w, a=a, exit_mode=exit_mode, exit_type=exit_type, place_layer = place_layer)                ##depth?
        ...
        super().init_exit_mobilevit(self, exit_type=exit_type, channels=channels, num_classes=num_classes, image_size=image_size, place_layer=place_layer) ##
